...
function removeLogoMenu(){const e=document.querySelector(".tm-header-menu-language-1 .gs-shop-logo-link"),t=document.querySelector(".tm-header-menu-language-1 .navbar.navbar-expand-lg"),f=document.querySelector('[id*="tm-footer-layout-2"]');return e&&(e.style.display="none"),t&&(t.style.padding="1.5rem"),f&&(f.style.display="none"),e&&t&&f}
